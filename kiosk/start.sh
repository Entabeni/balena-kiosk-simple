...
echo "chromium-browser $CHROME_LAUNCH_URL $FLAGS --disable-pinch –overscroll-history-navigation=0  --window-size=$WINDOW_SIZE --window-position=$WINDOW_POSITION $OUTPUT" >> /home/chromium/xstart.sh
